...
void ui_screen_music_player_show(void)
{
	...
	lv_obj_set_style_text_font(play_icon_label, &lv_font_montserrat_28, LV_PART_MAIN);
	...
	lv_obj_set_style_text_font(next_icon_label, &lv_font_montserrat_28, LV_PART_MAIN);
	...
	lv_obj_align_to(next_icon_label, play_icon_label, LV_ALIGN_OUT_RIGHT_MID, 24, 0);
	...
	lv_obj_set_style_text_font(prev_icon_label, &lv_font_montserrat_28, LV_PART_MAIN);
	...
	lv_obj_align_to(prev_icon_label, play_icon_label, LV_ALIGN_OUT_LEFT_MID, -24, 0);
	...
	lv_obj_set_style_text_font(elapsed_label, &lv_font_montserrat_14, LV_PART_MAIN);
	...
	lv_obj_set_style_text_font(duration_label, &lv_font_montserrat_14, LV_PART_MAIN);
	...
	lv_obj_set_style_text_font(volume_label, &lv_font_montserrat_28, LV_PART_MAIN);
